    ...
    return (
        <div style={{
            ...
            <div className='text-center pt-20'>
                ...
                <h2 className='text-3xl lg:text-4xl text-center text-white pb-12'>Stay connected with us</h2>
            </div>
           ...
           <form action="" className='flex flex-col justify-center items-center' >
            ...
            <Link className="btn btn-primary text-white bg-gradient-to-r from-primary to-secondary mb-10">Submit</Link>
            </form>
           </div>
        </div>
    );
